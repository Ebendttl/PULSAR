import {
  ...
  useDAppKit
} from "./chunk-QTN67PHT.js";
import "./chunk-XACUGL2W.js";
import "./chunk-ZBRKGITS.js";
import {
  require_jsx_runtime
...
import "./chunk-CKMFLLU3.js";
import {
  normalizeSuiNSName,
  promiseWithResolvers
} from "./chunk-JE7KFCAQ.js";
import {
  __commonJS,
  __privateAdd,
  __privateGet,
...
var require_StoreController = __commonJS({
  "node_modules/@nanostores/lit/lib/StoreController.js"(exports) {
    ...
    var StoreController = class {
      ...
      hostDisconnected() {
        var _a12;
        (_a12 = this.unsubscribe) === null || _a12 === void 0 ? void 0 : _a12.call(this);
      }
      /**
...
var require_MultiStoreController = __commonJS({
  "node_modules/@nanostores/lit/lib/MultiStoreController.js"(exports) {
    ...
    var MultiStoreController2 = class {
      ...
      hostDisconnected() {
        var _a12;
        (_a12 = this.unsubscribes) === null || _a12 === void 0 ? void 0 : _a12.forEach((unsubscribe) => unsubscribe());
      }
      /**
...
// node_modules/@mysten/dapp-kit-react/dist/ui.mjs
...
var createComponent = ({ react: React2, tagName, elementClass, events, displayName }) => {
  ...
  const ReactComponent = React2.forwardRef((props, ref) => {
    ...
    if (!NODE_MODE) {
      ...
      React2.useLayoutEffect(() => {
        var _a12;
        (_a12 = elementRef.current) == null ? void 0 : _a12.removeAttribute("defer-hydration");
      }, []);
    }
    if (NODE_MODE) {
...
(function() {
  ...
  var l = "function" == typeof Object.defineProperties ? Object.defineProperty : function(a, b, d2) {
  ...
  function p(a, b) {
    if (b) a: {
      ...
      e = d2[a];
      b = b(e);
      b != e && null != b && l(d2, a, { configurable: true, writable: true, value: b });
    }
  }
  p("Symbol", function(a) {
    function b(c) {
      if (this instanceof b) throw new TypeError("Symbol is not a constructor");
      return new d2("jscomp_symbol_" + (c || "") + "_" + e++, c);
    }
    function d2(c, f) {
      this.l = c;
  ...
  p("Symbol.iterator", function(a) {
    ...
    for (var b = "Array Int8Array Uint8Array Uint8ClampedArray Int16Array Uint16Array Int32Array Uint32Array Float32Array Float64Array".split(" "), d2 = 0; d2 < b.length; d2++) {
      var e = n[b[d2]];
  ...
  function r(a) {
    if (!(a instanceof Array)) {
      a = q(a);
      for (var b, d2 = []; !(b = a.next()).done; ) d2.push(b.value);
      a = d2;
    }
    return a;
  }
  var t = "function" == typeof Object.create ? Object.create : function(a) {
    ...
    function a() {
      ...
      new d2();
      Reflect.construct(d2, [], function() {
      });
      return new d2() instanceof d2;
    }
    if ("undefined" != typeof Reflect && Reflect.construct) {
      if (a()) return Reflect.construct;
      var b = Reflect.construct;
      return function(d2, e, c) {
        d2 = b(d2, e);
        c && Reflect.setPrototypeOf(d2, c.prototype);
        return d2;
      };
    }
    return function(d2, e, c) {
  ...
  I.prototype.define = function(a, b) {
    ...
    var d2 = b.prototype.attributeChangedCallback, e = new Set(b.observedAttributes || []);
    ha(b, e, d2);
    ...
    this === window.customElements && (G.set(b, d2), d2.o = c);
    if (c = this.i.get(a)) for (this.i.delete(a), c = q(c), e = c.next(); !e.done; e = c.next()) e = e.value, F.delete(e), J(e, d2, true);
    c = this.j.get(a);
    void 0 !== c && (c.resolve(b), this.j.delete(a));
    return b;
  };
  I.prototype.upgrade = function(a) {
    for (var b = [], d2 = 0; d2 < arguments.length; ++d2) b[d2] = arguments[d2];
    K.push(this);
  ...
  function L(a, b, d2, e) {
    var c = a.i.get(d2);
    c || a.i.set(d2, c = /* @__PURE__ */ new Set());
  ...
  function ia(a) {
    function b() {
      var d2 = Reflect.construct(C, [], this.constructor);
      Object.setPrototypeOf(d2, HTMLElement.prototype);
      a: {
        var e = d2.getRootNode();
    ...
    b.prototype.connectedCallback = function(d2) {
    ...
    b.prototype.disconnectedCallback = function(d2) {
      for (var e = [], c = 0; c < arguments.length; ++c) e[c] = arguments[c];
    ...
    b.prototype.adoptedCallback = function(d2) {
      for (var e = [], c = 0; c < arguments.length; ++c) e[c] = arguments[c];
      var f, g;
      null == (f = E.get(this)) || null == (g = f.adoptedCallback) || g.apply(this, e);
    };
    b.prototype.formAssociatedCallback = function(d2) {
      for (var e = [], c = 0; c < arguments.length; ++c) e[c] = arguments[c];
      c = E.get(this);
    ...
    b.prototype.formDisabledCallback = function(d2) {
      for (var e = [], c = 0; c < arguments.length; ++c) e[c] = arguments[c];
      c = E.get(this);
      if (null == c ? 0 : c.formAssociated) {
        var f;
    ...
    b.prototype.formResetCallback = function(d2) {
      for (var e = [], c = 0; c < arguments.length; ++c) e[c] = arguments[c];
      c = E.get(this);
      if (null == c ? 0 : c.formAssociated) {
        var f;
    ...
    b.prototype.formStateRestoreCallback = function(d2) {
      for (var e = [], c = 0; c < arguments.length; ++c) e[c] = arguments[c];
      c = E.get(this);
      if (null == c ? 0 : c.formAssociated) {
        var f;
  ...
  function J(a, b, d2) {
    ...
    d2 && b.connectedCallback && a.isConnected && b.connectedCallback.call(a);
  }
  var R = Element.prototype.attachShadow;
  Element.prototype.attachShadow = function(a, b) {
    for (var d2 = [], e = 1; e < arguments.length; ++e) d2[e - 1] = arguments[e];
    var c = Object.assign({}, a);
    e = a.customElements;
    e = void 0 === a.registry ? e : a.registry;
    c = (delete c.customElements, delete c.registry, c);
    d2 = R.call.apply(R, [this, c].concat(r(d2)));
    void 0 !== e && (d2.customElements = d2.registry = e);
    return d2;
  };
  var K = [document];
  function S(a, b, d2) {
    var e = (d2 ? Object.getPrototypeOf(d2) : a.prototype)[b];
  ...
  function T(a) {
    ...
    Object.defineProperty(a.prototype, "innerHTML", Object.assign({}, b, { set: function(d2) {
      K.push(this);
      b.set.call(this, d2);
      K.pop();
    } }));
  ...
  if (window.ElementInternals && window.ElementInternals.prototype.setFormValue) {
    ...
    methods.forEach(function(a) {
      var b = window.ElementInternals.prototype, d2 = b[a];
      b[a] = function(e) {
        for (var c = [], f = 0; f < arguments.length; ++f) c[f] = arguments[f];
        f = U.get(this);
        if (true === E.get(f).formAssociated) return null == d2 ? void 0 : d2.call.apply(d2, [this].concat(r(c)));
        throw new DOMException("Failed to execute " + d2 + " on 'ElementInternals': The target element is not a form-associated custom element.");
      };
    });
    ...
    var HTMLFormControlsCollection = function(a) {
      var b = this, d2 = /* @__PURE__ */ new Map();
      a.forEach(function(e, c) {
        var f = e.getAttribute("name"), g = d2.get(f) || [];
        b[+c] = e;
        g.push(e);
        d2.set(f, g);
      });
      this.length = a.length;
      d2.forEach(function(e, c) {
    ...
    Object.defineProperty(
      ...
      { get: function() {
        ...
        a = q(a);
        for (var d2 = a.next(); !d2.done; d2 = a.next()) {
          d2 = d2.value;
          var e = E.get(d2);
          e && true !== e.formAssociated || b.push(d2);
        }
...
var polyfillSupport = DEV_MODE2 ? global3.reactiveElementPolyfillSupportDevMode : global3.reactiveElementPolyfillSupport;
if (DEV_MODE2) {
  ...
  queueMicrotask(() => {
    ...
    if (((_a12 = global3.ShadyDOM) == null ? void 0 : _a12.inUse) && polyfillSupport === void 0) {
      issueWarning("polyfill-support-missing", `Shadow DOM is being polyfilled via \`ShadyDOM\` but the \`polyfill-support\` module has not been loaded.`);
    }
  });
}
var debugLogEvent = DEV_MODE2 ? (event) => {
...
var ReactiveElement = class extends HTMLElement {
  ...
  connectedCallback() {
    ...
    (_a12 = this.__controllers) == null ? void 0 : _a12.forEach((c) => {
      var _a13;
      return (_a13 = c.hostConnected) == null ? void 0 : _a13.call(c);
    });
  }
  /**
  ...
  disconnectedCallback() {
    ...
    (_a12 = this.__controllers) == null ? void 0 : _a12.forEach((c) => {
      var _a13;
      return (_a13 = c.hostDisconnected) == null ? void 0 : _a13.call(c);
    });
  }
  /**
  ...
  performUpdate() {
    ...
    try {
      ...
      if (shouldUpdate) {
        ...
        (_a12 = this.__controllers) == null ? void 0 : _a12.forEach((c) => {
          var _a13;
          return (_a13 = c.hostUpdate) == null ? void 0 : _a13.call(c);
        });
  ...
  _$didUpdate(changedProperties) {
    ...
    (_a12 = this.__controllers) == null ? void 0 : _a12.forEach((c) => {
      var _a13;
      return (_a13 = c.hostUpdated) == null ? void 0 : _a13.call(c);
    });
    if (!this.hasUpdated) {
...
var ChildPart = class _ChildPart {
  ...
  _$setValue(value, directiveParent = this) {
    ...
    if (isPrimitive(value)) {
      ...
      if (DEV_MODE3 && ((_a12 = this.options) == null ? void 0 : _a12.host) === value) {
...
var polyfillSupport2 = DEV_MODE3 ? global4.litHtmlPolyfillSupportDevMode : global4.litHtmlPolyfillSupport;
polyfillSupport2 == null ? void 0 : polyfillSupport2(Template, ChildPart);
(global4.litHtmlVersions ?? (global4.litHtmlVersions = [])).push("3.3.3");
...
var polyfillSupport3 = DEV_MODE4 ? global5.litElementPolyfillSupportDevMode : global5.litElementPolyfillSupport;
polyfillSupport3 == null ? void 0 : polyfillSupport3({ LitElement });
(global5.litElementVersions ?? (global5.litElementVersions = [])).push("4.2.2");
if (DEV_MODE4 && global5.litElementVersions.length > 1) {
  queueMicrotask(() => {
...
function query(selector, cache2) {
  return (protoOrTarget, nameOrContext, descriptor) => {
    const doQuery = (el) => {
      var _a12;
      const result = ((_a12 = el.renderRoot) == null ? void 0 : _a12.querySelector(selector)) ?? null;
...
var ClassMapDirective = class extends Directive {
  constructor(partInfo) {
    var _a12;
    super(partInfo);
    if (partInfo.type !== PartType.ATTRIBUTE || partInfo.name !== "class" || ((_a12 = partInfo.strings) == null ? void 0 : _a12.length) > 2) {
  ...
  update(part, [classInfo]) {
    ...
    if (this._previousClasses === void 0) {
      ...
      for (const name in classInfo) {
        if (classInfo[name] && !((_a12 = this._staticClasses) == null ? void 0 : _a12.has(name))) {
...
var Task = class {
  ...
  constructor(host, task, args) {
    ...
    if ("initialValue" in taskConfig) {
      ...
      this._previousArgs = (_a12 = this._getArgs) == null ? void 0 : _a12.call(this);
    }
  }
  hostUpdate() {
  ...
  async run(args) {
    ...
    this._previousArgs = args;
    if (this._status === TaskStatus.PENDING) {
      (_a12 = this._abortController) == null ? void 0 : _a12.abort();
    } else {
    ...
    if (this._callId === key) {
      if (result === initialState) {
        ...
        if (errored === false) {
          try {
            (_b2 = this._onComplete) == null ? void 0 : _b2.call(this, result);
          } catch {
          }
          this._status = TaskStatus.COMPLETE;
  ...
  abort(reason) {
    var _a12;
    if (this._status === TaskStatus.PENDING) {
      (_a12 = this._abortController) == null ? void 0 : _a12.abort(reason);
    }
  }
  /**
  ...
  render(renderer) {
    ...
    switch (this._status) {
      case TaskStatus.INITIAL:
        return (_a12 = renderer.initial) == null ? void 0 : _a12.call(renderer);
      case TaskStatus.PENDING:
        return (_b2 = renderer.pending) == null ? void 0 : _b2.call(renderer);
...
var __this_instances, walletClicked_fn, _a3;
var WalletListItem = (_a3 = class extends LitElement {
  constructor(..._args) {
    super(..._args);
...
var styles$3 = [sharedStyles, css`
	...
	`];
var _a4;
var Button = (_a4 = class extends LitElement {
  constructor(..._args) {
    super(..._args);
...
}, _a4.shadowRootOptions = {
  ...LitElement.shadowRootOptions,
  delegatesFocus: true
}, _a4.styles = styles$3, _a4);
...
var _a5;
var WalletList = (_a5 = class extends ScopedRegistryHost(LitElement) {
  constructor(..._args) {
    super(..._args);
    this.wallets = [];
  }
...
}, _a5.elementDefinitions = {
  "wallet-list-item": WalletListItem,
  "internal-button": Button
}, _a5.styles = styles$4, _a5);
__decorate([property({ type: Object })], WalletList.prototype, "wallets", void 0);
var _isOpen, _isOpening, _isConnected, _returnValue, _nextClickIsFromContent, _a6;
var BaseModal = (_a6 = class extends LitElement {
  constructor() {
    super(...arguments);
...
}, _isOpen = new WeakMap(), _isOpening = new WeakMap(), _isConnected = new WeakMap(), _returnValue = new WeakMap(), _nextClickIsFromContent = new WeakMap(), _a6.shadowRootOptions = {
  ...LitElement.shadowRootOptions,
  delegatesFocus: true
}, _a6);
...
var styles$2 = [sharedStyles, css`
	...
	`];
var _a7;
var ConnectionStatus = (_a7 = class extends LitElement {
  constructor(..._args) {
    super(..._args);
    this.title = "";
    this.copy = "";
...
`;
var _abortController, _DAppKitConnectModal$1_instances, renderModalView_fn, attemptConnect_fn, resetSelection_fn, getWallets_fn, _a8;
var DAppKitConnectModal = (_a8 = class extends ScopedRegistryHost(BaseModal) {
  constructor(..._args) {
    super(..._args);
  ...
  var _a12;
  if (this._state.view === "connecting") (_a12 = __privateGet(this, _abortController)) == null ? void 0 : _a12.abort("cancelled");
...
}, _a8.styles = [styles$1, iconButtonStyles], _a8.elementDefinitions = {
...
async function resolveNameServiceName(client, address) {
  ...
  try {
    const name = (_c = await ((_b2 = (_a12 = client.core).defaultNameServiceName) == null ? void 0 : _b2.call(_a12, { address }))) == null ? void 0 : _c.data.name;
...
var _resolveNameTask, _AccountMenuItem_instances, copyAddressToClipboard_fn, _renderAccountInfo, accountSelected_fn, _a9;
var AccountMenuItem = (_a9 = class extends LitElement {
  constructor(..._args) {
    super(..._args);
...
var _unsubscribeFromAutoUpdate, _resolveNameTask2, __this_instances2, onDisconnectClick_fn, onManageConnectionClick_fn, _getAccountTitle, _onDocumentClick, toggleMenu_fn, openMenu_fn, closeMenu_fn, startPositioning_fn, stopPositioning_fn, _a10;
var ConnectedAccountMenu = (_a10 = class extends ScopedRegistryHost(LitElement) {
  constructor(..._args) {
    super(..._args);
    __privateAdd(this, __this_instances2);
    __privateAdd(this, _unsubscribeFromAutoUpdate);
    __privateAdd(this, _resolveNameTask2, new Task(this, {
...
}, _a10.elementDefinitions = {
  "internal-button": Button,
  "account-menu-item": AccountMenuItem
}, _a10.styles = styles, _a10);
...
var _DAppKitConnectButton$1_instances, openModal_fn, _a11;
var DAppKitConnectButton = (_a11 = class extends ScopedRegistryHost(LitElement) {
  constructor() {
    super(...arguments);
  ...
  render() {
    ...
    return connection.account ? html`<connected-account-menu
      ...
      this.instance.connectWallet({ wallet: connection.wallet });
				...
				></connected-account-menu>` : html`<internal-button exportparts="trigger" @click=${__privateMethod(this, _DAppKitConnectButton$1_instances, openModal_fn)}>
						<slot>Connect Wallet</slot>
					</internal-button>
					<mysten-dapp-kit-connect-modal
						.instance=${this.instance}
						.filterFn=${(_a12 = this.modalOptions) == null ? void 0 : _a12.filterFn}
						.sortFn=${(_b2 = this.modalOptions) == null ? void 0 : _b2.sortFn}
					></mysten-dapp-kit-connect-modal>`;
  }
}, _DAppKitConnectButton$1_instances = new WeakSet(), openModal_fn = function() {
  this._modal.show();
}, _a11.elementDefinitions = {
  "internal-button": Button,
  "mysten-dapp-kit-connect-modal": DAppKitConnectModal,
  "connected-account-menu": ConnectedAccountMenu
}, _a11.shadowRootOptions = {
  ...LitElement.shadowRootOptions,
  delegatesFocus: true
}, _a11.styles = sharedStyles, _a11);
...
@lit-labs/scoped-registry-mixin/development/scoped-registry-mixin.js:
  (**
   * @license
   * Copyright 2021 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
...
@lit/task/development/index.js:
   ...
   *)
*/
//# sourceMappingURL=@mysten_dapp-kit-react_ui.js.map
