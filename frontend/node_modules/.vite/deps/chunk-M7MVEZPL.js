...
// node_modules/@mysten/dapp-kit-react/dist/useDAppKit-LUp-KcgG.mjs
...
// node_modules/@mysten/window-wallet-core/dist/web-wallet-channel/requests.mjs
...
var _popup, _version, _id, _hostOrigin, _hostPathname, _appName, _extraRequestOptions, _promise, _resolve, _reject, _interval, _isSendCalled, _listener, _DappPostMessageChannel_instances, cleanup_fn, _a3;
var DappPostMessageChannel = (_a3 = class {
  constructor({ appName, hostOrigin, hostPathname = "dapp-request", extraRequestOptions, popupWindow }) {
    ...
    __privateAdd(this, _listener, (event) => {
      ...
      if (output.payload.type === "reject") __privateGet(this, _reject).call(this, new Error(output.payload.reason || "User rejected the request"));
...
var _id2, _events, _accounts, _origin, _walletName, _icon, _name, _signTransactionBlock, _signTransaction, _signAndExecuteTransaction, _signPersonalMessage, _on, _SlushWallet_instances, setAccounts_fn, _connect, getPreviouslyAuthorizedAccounts_fn, _disconnect, getNewPopupChannel_fn, _a4;
var SlushWallet = (_a4 = class {
  constructor({ name, origin, metadata }) {
    ...
    __privateAdd(this, _signTransactionBlock, async ({ transactionBlock, account, chain }) => {
    ...
    __privateAdd(this, _signAndExecuteTransaction, async ({ transaction, account, chain }) => {
      const popup = __privateMethod(this, _SlushWallet_instances, getNewPopupChannel_fn).call(this);
    ...
    __privateAdd(this, _connect, async (input) => {
      if (input == null ? void 0 : input.silent) return { accounts: this.accounts };
...
function registerSlushWallet(name, { origin, metadataApiUrl = METADATA_API_URL } = {}) {
  ...
  wallets2.on("register", (wallet) => {
    if (wallet.id === SUI_WALLET_EXTENSION_ID) unregister == null ? void 0 : unregister();
  });
...
//# sourceMappingURL=chunk-M7MVEZPL.js.map
