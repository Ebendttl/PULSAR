...
function createFROST(opts) {
  ...
  const frost = {
    ...
    verifyShare(pub, commitmentList, msg, identifier, sigShare) {
      ...
      const r = commShare.add(PK.multiply(Fn2.mul(challenge2, lambda)));
      return l.equals(r);
    },
...
function montgomery(curveDef) {
  ...
  const maxAdded = is25519 ? BigInt(8) * _2n3 ** BigInt(251) - _1n6 : BigInt(4) * _2n3 ** BigInt(445) - _1n6;
...
var _DST_scalarBytes = asciiToBytes(_DST_scalar);
...
var ristretto255 = Object.freeze({ Point: _RistrettoPoint });
var ristretto255_hasher = Object.freeze({
  ...
  */
  hashToCurve(msg, options) {
    const DST = (options == null ? void 0 : options.DST) === void 0 ? "ristretto255_XMD:SHA-512_R255MAP_RO_" : options.DST;
...
var ristretto255_oprf = (() => createOPRF({
...
var ristretto255_FROST = (() => createFROST({
...
var ED25519_TORSION_SUBGROUP = Object.freeze([
...
var _a;
var Ed25519PublicKey = (_a = class extends PublicKey {
  /**
...
function isValidHardenedPath(path) {
  if (!new RegExp("^m\\/44'\\/784'\\/[0-9]+'\\/[0-9]+'\\/[0-9]+'+$").test(path)) return false;
  return true;
}
...
function SWUFpSqrtRatio(Fp2, Z) {
  ...
  const q = F.ORDER;
  let l = _0n7;
  for (let o = q - _1n8; o % _2n5 === _0n7; o /= _2n5)
    l += _1n8;
  const c1 = l;
  ...
  if (F.ORDER % _4n2 === _3n3) {
    const c12 = (F.ORDER - _3n3) / _4n2;
...
function ecdsa(Point, hash, ecdsaOpts = {}) {
  ...
  const hasLargeRecoveryLifts = CURVE_ORDER * _2n5 + _1n8 < Fp2.ORDER;
...
function createSWU(Point, opts) {
  let map2;
  return (scalars) => (map2 || (map2 = mapToCurveSimpleSWU(Point.Fp, opts)))(scalars[0]);
}
var p256_Point = weierstrass(p256_CURVE);
var p256 = ecdsa(p256_Point, sha256);
var p256_hasher = (() => {
...
var p256_FROST = (() => createFROST({
  name: "FROST-P256-SHA256-v1",
  Point: p256_Point,
  hashToScalar: p256_hasher.hashToScalar,
  hash: sha256
}))();
var p384_Point = weierstrass(p384_CURVE);
var p384 = ecdsa(p384_Point, sha384);
var p384_hasher = (() => {
...
var p521_Point = weierstrass(p521_CURVE);
var p521 = ecdsa(p521_Point, sha512);
var p521_hasher = (() => {
...
var _a2;
var PasskeyPublicKey = (_a2 = class extends PublicKey {
  /**
...
}, _a2.SIZE = PASSKEY_PUBLIC_KEY_SIZE, _a2);
...
// node_modules/@mysten/sui/dist/zklogin/poseidon.mjs
...
function toPaddedBigEndianBytes(num2, width) {
  return hexToBytes(num2.toString(16).padStart(width * 2, "0").slice(-width * 2));
}
...
var _data, _client, _legacyAddress, _ZkLoginPublicIdentifier_instances, toLegacyAddress_fn, _a3;
var ZkLoginPublicIdentifier = (_a3 = class extends PublicKey {
  /**
  ...
  */
  ...
  static fromBytes(bytes, { client, address, legacyAddress } = {}) {
    let publicKey;
    if (legacyAddress === true) publicKey = new _a3(normalizeZkLoginPublicKeyBytes(bytes, true), { client });
    else if (legacyAddress === false) publicKey = new _a3(normalizeZkLoginPublicKeyBytes(bytes, false), { client });
    else if (address) {
      publicKey = new _a3(normalizeZkLoginPublicKeyBytes(bytes, false), { client });
      if (publicKey.toSuiAddress() !== address) publicKey = new _a3(normalizeZkLoginPublicKeyBytes(bytes, true), { client });
    } else publicKey = new _a3(bytes, { client });
  ...
  */
  verifyPersonalMessage(message, signature) {
    ...
    return graphqlVerifyZkLoginSignature({
      address: new _a3(parsedSignature.publicKey).toSuiAddress(),
...
var _a4;
var Secp256k1PublicKey = (_a4 = class extends PublicKey {
  /**
...
var _pubkey, _signers, _a6;
var MultiSigSigner = (_a6 = class extends Signer {
  constructor(pubkey, signers = []) {
    ...
    for (const signer of signers) {
      ...
      const weight = (_a9 = weights.find((w) => w.address === address)) == null ? void 0 : _a9.weight;
...
}, _pubkey = new WeakMap(), _signers = new WeakMap(), _a6);
  ...
  */
  combinePartialSignatures(signatures) {
    ...
    for (let i = 0; i < signatures.length; i++) {
      ...
      let publicKey;
      if (parsed.signatureScheme === "ZkLogin") publicKey = toZkLoginPublicIdentifier((_a9 = parsed.zkLogin) == null ? void 0 : _a9.addressSeed, (_b = parsed.zkLogin) == null ? void 0 : _b.iss, { legacyAddress: false }).toRawBytes();
...
async function getSupportedIntentsFromFeature(wallet) {
  ...
  return ((_b = await ((_a9 = getWalletFeature(wallet, "sui:getCapabilities")) == null ? void 0 : _a9.getCapabilities())) == null ? void 0 : _b.supportedIntents) ?? [];
}
...
function getDefaultAppName() {
  var _a9;
  return ((_a9 = document.querySelector(`meta[name="application-name"]`)) == null ? void 0 : _a9.content) || document.title;
}
...
var _chainConfig, _keypair, _account, _on, _connect, _signPersonalMessage, _signTransaction, _signAndExecuteTransaction, _a7;
var UnsafeBurnerWallet = (_a7 = class {
  constructor({ clients }) {
...
}, _chainConfig = new WeakMap(), _keypair = new WeakMap(), _account = new WeakMap(), _on = new WeakMap(), _connect = new WeakMap(), _signPersonalMessage = new WeakMap(), _signTransaction = new WeakMap(), _signAndExecuteTransaction = new WeakMap(), _a7);
...
var _publicKeyCache, _dAppKit, _a8;
var CurrentAccountSigner = (_a8 = class extends Signer {
  constructor(dAppKit) {
    super();
...
}, _publicKeyCache = new WeakMap(), _dAppKit = new WeakMap(), _a8);
